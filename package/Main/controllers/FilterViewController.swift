...
class FilterViewController: BaseViewController ,UICollectionViewDelegate,UICollectionViewDataSource{
...
//        layout.estimatedItemSize = CGSize.init(width: UIScreen.main.bounds.width - 30, height: 50)
    ...
    func getCollection() -> UICollectionView {
        ...
        collectionView.register(FilterViewCollectionHeaderView.classForCoder(), forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: "headerView")
        collectionView.register(FilterCollectionCell.classForCoder(), forCellWithReuseIdentifier: "cell")
...
extension FilterViewController{
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let reuseview : FilterViewCollectionHeaderView = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionElementKindSectionHeader , withReuseIdentifier: "headerView", for: indexPath) as! FilterViewCollectionHeaderView
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let  cell : FilterCollectionCell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! FilterCollectionCell
...
class FilterViewCollectionHeaderView : UICollectionReusableView {
