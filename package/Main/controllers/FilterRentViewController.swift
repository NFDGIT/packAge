//
//  FilterRentRentViewController.swift
//  package
//
...
class FilterRentViewController: BaseViewController,UICollectionViewDelegate,UICollectionViewDataSource{
...
//        layout.estimatedItemSize = CGSize.init(width: width, height: height)
    ...
    func getCollection() -> UICollectionView {
        ...
        collectionView.register(FilterRentViewCollectionHeaderView.classForCoder(), forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: "headerView")
        collectionView.register(FilterRentCollectionCell.classForCoder(), forCellWithReuseIdentifier: "cell")
    ...
    override func initNavi() {
        super.initNavi()
        self.navigationItem.title = "选择租金"
    ...
    func refreshData(){
        ...
        let datas : Array<Any> = [
            ["name":"筛选","districts":[
                ["min":"","max":"","selected":true],
                ["min":"600","max":"1000","selected":false],
                ["min":"1000","max":"1500","selected":false],
                ["min":"1500","max":"2000","selected":false],
                ["min":"2000","max":"2500","selected":false],
                ["min":"2500","max":"3000","selected":false],
                ["min":"3000","max":"3500","selected":false],
                ["min":"3500","max":"4000","selected":false],
                ["min":"4000","max":"4500","selected":false],
                ["min":"4500","max":"5000","selected":false],
                ["min":"5000","max":"5500","selected":false],
                ["min":"5500","max":"6000","selected":false],
                ["min":"6000","max":"6500","selected":false],
                ["min":"6500","max":"7000","selected":false],
                ["min":"7000","max":"","selected":false]
                ]
            ]
...
extension FilterRentViewController{
    
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        let dic  :  Dictionary<String,Any> = self.datas[indexPath.section] as! Dictionary<String,Any>
        
        let reuseview : FilterRentViewCollectionHeaderView = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionElementKindSectionHeader , withReuseIdentifier: "headerView", for: indexPath) as! FilterRentViewCollectionHeaderView
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let  cell : FilterRentCollectionCell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! FilterRentCollectionCell
        
        
        let min : String = cityDic["min"] as! String
        let max : String = cityDic["max"] as! String
...
class FilterRentViewCollectionHeaderView : UICollectionReusableView {
...
class FilterRentCollectionCell: UICollectionViewCell {
    let btn : UIButton = UIButton.init()
